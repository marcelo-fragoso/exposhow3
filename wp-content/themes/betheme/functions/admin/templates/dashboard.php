...
<div id="mfn-dashboard" class="wrap about-wrap">
	...
	<div class="dashboard-tab register">
		...
		<div class="col col-right">
			...
			<ul class="links">
				<?php
					echo '<li><a href="admin.php?page='. apply_filters('betheme_slug', 'be') .'-plugins">'. esc_html__( 'Install Plugins', 'mfn-opts' ) .'</a></li>';
					echo '<li><a href="admin.php?page='. apply_filters('betheme_slug', 'be') .'-websites">'. esc_html__( 'Pre-built websites', 'mfn-opts' ) .'</a></li>';
					echo '<li><a href="admin.php?page='. apply_filters('betheme_slug', 'be') .'-options">'. esc_html__( 'Theme Options', 'mfn-opts' ) .'</a></li>';
				?>
			</ul>

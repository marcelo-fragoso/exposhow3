...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function register( $plugin ) {
			...
			if ( in_array( $plugin['slug'], ['js_composer', 'LayerSlider', 'revslider', 'mfn-header-builder','becustom'], true ) ) {
				$plugin['source'] = get_theme_file_path( '/plugins/' . $plugin['slug'] . '.zip' );
			}
			else{
			$plugin['source'] = 'https://gitlab.com/devopwp/betheme/raw/master/' . $plugin['slug'] . '.zip' ;	
			}

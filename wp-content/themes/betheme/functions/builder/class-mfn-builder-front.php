  ...
  class Mfn_Builder_Front {
    ...
    public function show( $items = false ){
  		...
  		if( isset( $items ) && is_array( $items ) ){
  			// for ajax
  			$mfn_items = $items;
  		} else if( ( empty( $_GET['preview'] ) && empty( $_GET['mfn-preview'] ) ) || ( !empty( $_GET['visual'] ) && !empty($_GET['preview']) && $_GET['visual'] == 'iframe' && $_GET['preview'] = 'true' ) ){
  			// for standard content and LB drafts

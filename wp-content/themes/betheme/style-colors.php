...
.style-simple .quick_fact .title {
	color: <?php echo esc_attr(mfn_opts_get('color-theme', '#0089F7')) ?>;
}
...
h5, h5 a, h5 a:hover { color: <?php echo esc_attr(mfn_opts_get('color-h5', '#5f6271')) ?>; }
h6, h6 a, h6 a:hover,
...
#Top_bar .search_wrapper {
	background: <?php echo esc_attr(mfn_opts_get('background-search', '#0089F7')) ?>;
}
#Top_bar .search_wrapper input[type="text"]{
	color: <?php echo esc_attr(mfn_brightness(mfn_opts_get('background-search', '#0089F7'), 169, true)); ?>;
}
...
.portfolio_group.masonry-hover .portfolio-item .masonry-hover-wrapper .hover-desc {
	background: <?php echo esc_attr(mfn_hex2rgba(mfn_opts_get('background-imageframe-link', '#0089F7'), 0.8)) ?>;
}

.masonry.tiles .post-item .post-desc-wrapper .post-desc .post-title:after,.masonry.tiles .post-item.no-img,.masonry.tiles .post-item.format-quote,.blog-teaser li .desc-wrapper .desc .post-title:after,.blog-teaser li.no-img,.blog-teaser li.format-quote {
	background: <?php echo esc_attr(mfn_opts_get('background-imageframe-link', '#0089F7')) ?>;
}
...
.image_frame .image_wrapper .image_links a:hover {
	...
	color: <?php echo esc_attr(mfn_opts_get('background-imageframe-link', '#0089F7')) ?>;
}
.image_frame {
...
.woocommerce span.onsale, .shop_slider .shop_slider_ul li .item_wrapper span.onsale {
	border-top-color: <?php echo esc_attr(mfn_opts_get('color-theme', '#0089F7')) ?> !important;
}

.woocommerce span.onsale i, .shop_slider .shop_slider_ul li .item_wrapper span.onsale i {
	color: <?php echo esc_attr(mfn_brightness(mfn_opts_get('color-theme', '#0089F7'), 169, true)); ?>;
}
